...
const PaymentHistory = () => {
    ...
    return (
        <div className="w-full">
            <h1 className="text-3xl font-bold text-center bottom-2 bg-blue-300 py-4 text-blue-900">Payment History</h1>
            ...
            <div className="overflow-x-auto w-full">
                <table className="table w-full">
                    ...
                    <tbody>
                        {
                            myEnrolledClasses.reverse().map((classs, index) => <tr
                                key={classs._id}
                            >
                                <td>
                                    {index + 1}
                                ...
                                <td className="font-bold">{classs.date}</td>
                                <td className="font-bold">{classs.transactionId}</td>
